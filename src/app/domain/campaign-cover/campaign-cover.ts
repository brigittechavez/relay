 ...
 * Portada de campaña.
 *
 * Hasta que existan las imágenes definitivas, la portada es una composición
 * geométrica derivada del identificador de la campaña: siempre la misma para
 * la misma campaña, distinta entre campañas y coherente con la paleta. No es
 * un gradiente decorativo ni una imagen de banco: es un marcador de posición
 * que reserva la proporción exacta que ocupará la imagen final, de modo que no
 * habrá salto de layout al sustituirlo.
 */
@Component({
    ...
    >
      @switch (pattern()) {
        ...
        @case (1) {
          ...
          <path d="M188 180 L288 46 L320 46 L320 180 Z" [attr.fill]="shapeColor()" opacity="0.5" />
        }
        @case (2) {
          <rect
            x="196"
